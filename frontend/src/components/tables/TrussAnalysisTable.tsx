...
export default function TrussAnalysisTable({
  current,
}: {
          ...
          {reactions.map((rxn, index) => (
            ...
            >
              ...
              <span className="border-r border-secondary px-4 py-1">
                {getRounded(rxn[4], precision)}
              </span>
              <span className="border-r border-secondary px-4 py-1">
                {getRounded(rxn[5], precision)}
              </span>
          ...
          {action.map((rxn, index) => (
            ...
            >
              <span className="px-4 py-2">
                {nodes.findIndex((x) => x[0] === rxn[1] && x[1] === rxn[2])}
              </span>

              <span className="border-x border-secondary px-4 py-1">
                {getRounded(rxn[3], precision)}
              </span>
              <span className="border-r border-secondary px-4 py-1"> - </span>
              <span className="px-4 py-2"> - </span>
            </div>
          ))}
        </div>
